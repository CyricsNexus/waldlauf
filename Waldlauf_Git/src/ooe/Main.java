...
public class Main {
	...
	*********************************************************************************/
	...
	private static ListeBegegnung addBegegnungenImSpiel() {
		...
		listeBegegnung.addBegegnung("Dr. Snuggles", 
		...
		listeBegegnung.addBegegnung("Batman", 
		...
		listeBegegnung.addBegegnung("Pennywise", 
		...
		listeBegegnung.addBegegnung("T-Rex", 
		...
		listeBegegnung.addBegegnung("Baum", 
		...
		listeBegegnung.addBegegnung("Lama", 
